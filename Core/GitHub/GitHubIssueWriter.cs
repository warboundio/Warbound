...
public class GitHubIssueWriter
{
    ...
    public override string ToString()
    {
        ...
        if (IsPlanRequired)
        {
            ...
            sb.AppendLine($"Your first pull request should only consist of this plan. After you submit this pull request a developer will review it and make edits. If you see 'requested changes' that means that the developer has approved your plan and is ready for implementation. Please review the developers comments to confirm. Ensure your plan speaks to every required change and (if necessary) it's purpose. You will not be able to extend your scope after we move away from this step. Once you have moved onto the implementation stage the plan is immutable.");
            sb.AppendLine("");
            stepNumber++;
        }

        sb.AppendLine($"# Step {stepNumber} | **Implementation**");
        sb.AppendLine($"Do not scope creep outside of the approved upon plan. It is during the implementation step that you are to update the documentation for any classes, namespaces, and projects to reflect current state.");
        ...
        sb.AppendLine($"Please review the appropriate {SelectedProject}/DraftsX.md files and look for a draft that matches this github issue description and title: '{WorkflowTitle}'. Please remove that draft as it is no longer needed.");
